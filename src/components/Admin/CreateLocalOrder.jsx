...
const CreateLocalOrder = () => {
    ...
    const handleAssignOrder = async (e) => {
        ...
        // ✅ REAL JavaScript Date for deadline (with timezone applied)
        const newDeadline = moment(deadline?.date)
            .tz(deadline?.timezoneName)
            .toDate(); // ✅ REAL DATE OBJECT

        // ✅ REAL Date for order date
        const selectedOrderDate = formData.date
            ? moment(formData.date, 'DD-MMM-YYYY').toDate()
            : new Date();

        const updateOrder = {
            ...formData,
            date: selectedOrderDate, // ✅ Date object
            ...
            orderDeadLine: newDeadline, // ✅ Date object
            orderStatus: 'Pending',
        };
    ...
    return (
        <div className="max-w-6xl mx-auto p-5 bg-gray-100">
            ...
            <form
                ...
                className="bg-white shadow-md rounded-lg p-6 border border-gray-200 space-y-8"
            >
                {/* Section: Dates */}
                <div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                {clientID.map((client, idx) => (
                                    <option key={idx} value={client.clientID}>
                                        {client.clientID}
                                    </option>
                                ))}
                            </select>
                ...
                <div>
                    ...
                    <div className="mb-4">
                        ...
                        >
                            ...
                            <option value="Multi clipping path">
                                Multi clipping path
                            </option>
                            <option value="Transparent background">
                                Transparent background
                            </option>
                            <option value="White background">
                                White background
                            </option>
                            <option value="Color background">
                                Color background
                            </option>
                            <option value="Hair masking">Hair masking</option>
                            <option value="Single Selection">
                                Single Selection
                            </option>
                            <option value="Multi Selection">
                                Multi Selection
                            </option>
                            <option value="Drop shadow">Drop shadow</option>
                            <option value="Natural shadow">
                                Natural shadow
                            </option>
                            ...
                            <option value="Ghost mannequin effect">
                                Ghost mannequin effect
                            </option>
                            <option value="Basic retouching">
                                Basic retouching
                            </option>
                            <option value="High-end retouching">
                                High-end retouching
                            </option>
                            <option value="Jewelry retouching">
                                Jewelry retouching
                            </option>
                            <option value="Skin retouching">
                                Skin retouching
                            </option>
                            ...
                            <option value="Image resizing">
                                Image resizing
                            </option>
                            <option value="Raster to vector">
                                Raster to vector
                            </option>
                            <option value="Lighting adjustment">
                                Lighting adjustment
                            </option>
                ...
                <div className="modal-box">
                    <form method="dialog">
                        <button
                            ...
                            onClick={() => handleServiceRemove('Color change')}
                        >
                            ✕
                        </button>
                    </form>
                ...
                <div className="modal-box">
                    <form method="dialog">
                        <button
                            className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2"
                            onClick={() =>
                                handleServiceRemove('Image resizing')
                            }
                        >
                            ✕
                        </button>
